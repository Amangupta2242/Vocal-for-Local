...
<div class="container text-center">    
    <h3 style="font-family: monospace; background-color:#ff5454"><b>Fatehpur - Berma Chowk - Utensils</b></h3><br>

<?php 

/*Here i have added te button which need to style at the end*/
include 'controller/db.php';
$sql='SELECT * FROM product WHERE Type="Utensils" and Market="Berma Chowk" ORDER BY Product ASC';
