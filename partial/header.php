...
<nav class="navbar" style="background-color: white;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a  href="home.php"><img src="img/logo.png " alt="logo"style="width:120px;height:50px;" ></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        <li><a href="./home.php"><font size=3> Vocal of Local</a></li></font>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="contact.php"><span class="glyphicon glyphicon-globe"></span></span><font size=3> Feedback</a></li></font>';
            }
          ?>	    
		  </ul>
    </div>
